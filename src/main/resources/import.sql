...
CREATE TABLE IF NOT EXISTS HUMAN ( ID INT NOT NULL AUTO_INCREMENT, CHARACTER_ID INT NOT NULL, JOB_ID INT, SCHOOL VARCHAR(20), COME_FROM VARCHAR(20), MENTAL_DISORDER VARCHAR(20), SEX VARCHAR(20), AGE INT);
...
CREATE TABLE IF NOT EXISTS WEAPON ( ID INT NOT NULL AUTO_INCREMENT, BELONGING_ID INT, ACCURACY INT, DAMAGE INT, RANGE INT, REMARKS INT);
...
INSERT INTO HUMAN (CHARACTER_ID, JOB_ID, SCHOOL, COME_FROM, MENTAL_DISORDER, SEX, AGE) VALUES (1, 1, 'hoge', '', '', 'otoko', 20);